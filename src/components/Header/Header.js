      ...
      <header className="header">
        ...
        <nav className="header-nav">
          <section className="header-nav__links">
            ...
            <button className="header-nav__access">Accessibility</button>
            <div className="header-nav__language-container">
              <img
                ...
                src={GlobeImage}
              ></img>
              <button className="header-nav__language">English</button>
            </div>
          </section>
          <section className="header-nav__account">
            <img
              className="header-nav__account-logo"
              alt="account logo"
              src={AccountImage}
            ></img>
            <span className="header-nav__info">Rachel</span>
            <span className="header-nav__info">10,000 pts</span>
          </section>
        </nav>
      </header>
      <Navbar />
